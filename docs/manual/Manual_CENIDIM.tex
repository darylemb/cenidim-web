...
\begin{longtable}{p{0.9cm}p{3.4cm}p{9.4cm}}
  ...
  \pend & Herramientas &
    Deriva de formato: el árbol fue formateado con el ruff 0.3.x que
    pinea \codigo{.pre-commit-config.yaml}, pero el ruff resuelto por
    \codigo{uv.lock} (0.15) reformatearía 51 archivos, por lo que
    \codigo{ruff format} no es puerta de CI. Conviene alinear
    versiones o reformatear en un commit puramente mecánico. \\
  \bottomrule
